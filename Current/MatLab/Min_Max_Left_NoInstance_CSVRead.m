function Min_Max_Left_NoInstance_CSVRead()
...
Upper_Arm_Phi_Left = [UAPmax; Upper_Arm_Phi_max; UAPmin; Upper_Arm_Phi_min];
Upper_Arm_Theta_Left = [UATmax; Upper_Arm_Theta_max; UATmin; Upper_Arm_Theta_min];
Forearm_Phi_Left = [FPmax;Forearm_Phi_max;FPmin; Forearm_Phi_min];
Forearm_Theta_Left = [FTmax;Forearm_Theta_max; FTmin; Forearm_Theta_min];
Hand_Phi_Left = [HPmax; Hand_Phi_max; HPmin; Hand_Phi_min];
Hand_Theta_Left = [HTmax; Hand_Theta_max; HTmin; Hand_Theta_min];
...
T = table(Upper_Arm_Phi_Left, Upper_Arm_Theta_Left, Forearm_Phi_Left, Forearm_Theta_Left, Hand_Phi_Left, Hand_Theta_Left, 'RowNames', RowNames);
